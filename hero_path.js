const heroPath = "Hello Hero, you have entered the great colosseum of Js-topia you are nearing the end of the rule-all tournament you have 2 fights left good luck...";
//console.log(samPath)
...
let choice = 3
if (choice == 1){
    console.log("You succefully dodged left and hit opponent with your technique Susanoo");
}else if (choice == 2){
...
let secChoiceWastwo = 1
     if(secChoiceWastwo == 1){
        console.log("Game over... you failed as a Hero, drop weapons and let opponent kill you") //this ends in you losing
...
//if previous choice was 3
        console.log("After missing your opponent you can ready your Hasso No Kamae stance (1) or (2)")
