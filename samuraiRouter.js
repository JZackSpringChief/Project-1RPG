...
samuraiRouter.get("/:choiceOne", (req, res)=> {
...
samuraiRouter.get("/:choiceOnce/path", (req, res)=> {
    res.send(roundTwo)
})

samuraiRouter.get("/:choiceOne/path/:choiceTwo", (req, res) => {
    if(req.params.choiceTwo == 1){
        res.send("ohhh noo! you got hit for getting cocky!") 
    }else if (req.params.choiceTwo == 2){
        res.send("Relax your muscles, breathe slowly and land 10 consecutive hits!")
    }else {
